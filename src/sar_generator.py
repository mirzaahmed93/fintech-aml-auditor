...
def generate_fincen_sar_dossier(tx, audit_res):
    ...
    dossier = f"""================================================================================
FINCEN FORM 111: SUSPICIOUS ACTIVITY REPORT (SAR)
DEPARTMENT OF THE TREASURY - FINANCIAL CRIMES ENFORCEMENT NETWORK
Electronic Filing Tracking Number: {report_id}
...
--------------------------------------------------------------------------------
{cdd_flag} 31 CFR 1010.230 - Third-Party Payment Risk (Originator / Invoice Entity Mismatch)
...
1. Identity Vector (Name Matching):
   ...
   - Calculated Similarity: {score * 100:.1f}% (Regulatory Threshold Standard: >= 90.0%)
...
2. Structuring Vector (Velocity & Amount Corridor):
   - CTR Proximity Index: {structuring_risk:.2f} / 1.00
...
3. Geographic Vector (Jurisdictional Exposure):
   ...
   - Jurisdictional Risk Index: {jurisdiction_risk:.2f} / 1.00
...
4. Composite AML Risk Assessment:
   - Composite Risk Index: {composite_risk:.2f} / 1.00
...
Regulatory Rule Mapped:         docs/fincen_bsa_manual.md -> FinCEN CDD Final Rule (31 CFR 1010.230)
...
failing the statutory 90.0% standard mandated under the FinCEN Customer Due Diligence (CDD)
Final Rule (31 CFR 1010.230).
...
Money Laundering (TBML) and third-party invoice diversion.
